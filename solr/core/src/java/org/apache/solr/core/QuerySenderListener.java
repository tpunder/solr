...
public class QuerySenderListener extends AbstractSolrEventListener {
  ...
  public void newSearcher(SolrIndexSearcher newSearcher, SolrIndexSearcher currentSearcher) {
    ...
    log.info("QuerySenderListener done. Time: {} ms", TimeUnit.MILLISECONDS.convert(System.nanoTime() - startTimeNanos, TimeUnit.NANOSECONDS));
  }
  ...
  private void runQuery(SolrIndexSearcher newSearcher, SolrIndexSearcher currentSearcher, NamedList<Object> nlst) {
    try {
